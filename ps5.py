...
browser.get("https://www.bestbuy.ca/en-ca/product/playstation-5-console/15689336")
...
search_location = browser.find_element(By.XPATH,
                                       value='//*[@id="root"]/div/div[3]/div[2]/div[1]/div[2]/div[3]/div[3]/div/div[2]/div[2]/button[1]/span')
...
while not in_stock:
    check_stock = browser.find_element(By.XPATH,
                                       value='//*[@id="root"]/div/div[3]/div[2]/div[1]/div[2]/div[3]/div[3]/div/div[2]/div[1]/p[1]').text
